...
var tagsListExperimental = setOf(
...
val byOriginTagsSimple = setOf(
    "aboriginal", "african", "afrobeats", "americana", "arabic", "asian", "banda", "bollywood",
    "caribbean", "celtic", "ethnic", "greek", "grupera", "grupero", "indian music",
    "latin", "méxico", "national", "spanish"
)


var tagsListByOrigin = setOf(
...
val otherTagsSimple = setOf(
    "children", "disney", "juvenil", "kids",
    "moi merino", "singer-songwriter", "student", "university"
)

var tagsListOther = setOf(
...
val QUEEN_NET_URL =
    "http://n06.radiojar.com/4gw72qm8u68uv?rj-ttl=5&rj-tok=AAABhuNtzuUAEIBZr_gdGrrSlQ"
